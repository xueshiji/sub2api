...
func init() {
	...
	// groupDescOffPeakRateMultiplier is the schema descriptor for off_peak_rate_multiplier field.
	groupDescOffPeakRateMultiplier := groupFields[7].Descriptor()
	// group.DefaultOffPeakRateMultiplier holds the default value on creation for the off_peak_rate_multiplier field.
	group.DefaultOffPeakRateMultiplier = groupDescOffPeakRateMultiplier.Default.(float64)
